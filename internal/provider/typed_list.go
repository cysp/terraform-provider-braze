...
// Elements returns a copy of the list elements to prevent external mutation.
func (v TypedList[T]) Elements() []T {
	if v.elements == nil {
		return []T{}
	}

	return slices.Clone(v.elements)
}

// Len returns the number of elements in the list.
// Returns 0 for null or unknown lists.
func (v TypedList[T]) Len() int {
